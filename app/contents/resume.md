...
現在は、正社員の求人を探しております。
直近で、体調面による環境起因で短期離職が続いているため、中長期的に勤務できる環境を希望しております。
その上で、開発に取り組んでいき、UXなど、自身の強みを活かした開発ができるポジションに行きたいです。
...
### フロントエンド
実務経験が一番長い分野で、0 → 1 フェーズの基盤構築の経験もあります。
基本的には、フロントエンド開発を専門領域としています。
...
### バックエンド
基本的なAPI開発を得意としています。
API仕様やDB設計の経験もありますが、インフラまで含めた基盤構築については実務経験上はあまりないです。
(個人開発では経験あり)
...
## 希望条件・その他共有事項
<!-- **現在はフリーランスで活動しているため、業務委託契約でのお話を優先しております。** -->
### 働き方
...
##### 稼働場所
- スケジュールの都合上、原則フルリモートでの在宅勤務になります。会社拠点については、日本全国問わずOKです。
- 業務上で恒常的な出社が必要な案件については、NGではないですが、優先度を下げている状態です。ただし、単発的なイベントでの出社とかについては、スケジュール次第で参加できる可能性がありますので、こちらについては要相談とさせてください。
  - 万が一、案件上出社が必要な場合、後述の「ハイブリッドワークについて」の項目に詳しい条件が書いてありますので、ご確認ください。
...
- フルリモート or ハイブリッドを希望します。週3までの出社が可能です。
- フレックスタイムを導入してる職場を希望します(詳細は後述)
  - 現在フレックスタイムを整備してる企業様についても、ウェルカムなので、一度面談でお話させてください

#### ハイブリッドワークについて
後述の体調面の問題から、基本的には**週3までの出社**を条件としています。週4以上出社の企業様については、体調面考慮して、原則NGとしています。
